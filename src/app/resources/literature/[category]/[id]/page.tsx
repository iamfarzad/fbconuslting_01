...
export default function LiteratureDetailPage({ params }: { params: { category: string; id: string } }) {
  ...
  const breadcrumbSegments = [
    { name: "Literature", href: "/resources/literature" }, // Adjusted base path
    { name: categoryName, href: `/resources/literature/${category}` }, // Adjusted base path
    { name: item.title, href: `/resources/literature/${category}/${id}` }, // Adjusted base path
  ];
