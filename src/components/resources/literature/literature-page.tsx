...
import LiteratureCard from "./literature-card" // Corrected import path
...
import {
  ...
  BreadcrumbLink,
  BreadcrumbSeparator,
} from "@/components/ui/breadcrumb" // Import sub-components
...
export default function LiteraturePage() {
  ...
  const breadcrumbSegments = [{ name: "Literature", href: "/resources/literature" }]; // Adjusted base path

  return (
    <div className="container mx-auto px-4 py-12">
      {/* Refactored Breadcrumb */}
      <Breadcrumb className="mb-8">
        <BreadcrumbList>
          {breadcrumbSegments.map((segment, index) => (
            <React.Fragment key={segment.href}>
              <BreadcrumbItem>
                {/* Literature page is always the last segment here */}
