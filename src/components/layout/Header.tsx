...
const Header = () => {
  ...
  const navItems = [
    ...
    { name: 'Workshop', href: '/workshop' }, // Updated name and href
    { name: 'Resources', href: '/resources/literature' } // Updated href
  ];
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          <div className="flex items-center">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
            >
              <span className="text-foreground font-display font-bold text-xl">FB Consulting</span>
            </motion.a>
          </div>
